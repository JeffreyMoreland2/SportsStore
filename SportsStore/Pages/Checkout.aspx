    ...
    <div id="content">
        ...
        <div id="checkoutForm" class="checkout" runat="server">
            ...
            <div>
                ...
                <SX:VInput Property="Name" runat="server"></SX:VInput>
                </div>
            
            <h3>Address</h3>
            <div>
                <label for="line1">Line 1:</label>
                <SX:VInput Property="Line1" runat="server"></SX:VInput>
            </div>
            <div>
                <label for="line2">Line 2:</label>
                <SX:VInput Property="Line2" runat="server"></SX:VInput>
            </div>
            <div>
                <label for="line3">Line 3:</label>
                <SX:VInput Property="Line3" runat="server"></SX:VInput>
            </div>
            <div>
                <label for="city">City:</label>
                <SX:VInput Property="City" runat="server"></SX:VInput>
            </div>
            <div>
                <label for="state">State:</label>
                <SX:VInput Property="State" runat="server"></SX:VInput>
            </div>
